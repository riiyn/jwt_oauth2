...
INSERT INTO `auth` VALUES (1,'/deleteUser/**,/addUser'),(2,'/register/**,/login,/logout');
...
INSERT INTO `oauth_client_details` VALUES ('riiyn_appclient',NULL,'riiyn001','all','password,refresh_token',NULL,NULL,3600,7200,NULL,NULL),('riiyn_webclient',NULL,'riiyn000','all','password,refresh_token',NULL,NULL,3600,7200,NULL,NULL);
...
CREATE TABLE `role_auth` (
  ...
  KEY `role_auth_auth_id_fk` (`aid`),
  KEY `role_auth_role_id_fk` (`rid`),
  CONSTRAINT `role_auth_auth_id_fk` FOREIGN KEY (`aid`) REFERENCES `auth` (`id`),
  CONSTRAINT `role_auth_role_id_fk` FOREIGN KEY (`rid`) REFERENCES `role` (`id`)
...
INSERT INTO `role_auth` VALUES (1,1),(1,2),(2,1);
...
INSERT INTO `user` VALUES (1,'zs','000',0),(2,'admin','111',0);
...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `user_role_user_id_fk` FOREIGN KEY (`uid`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role` VALUES (1,2),(2,1),(2,2);
...
-- Dump completed on 2021-04-11 15:40:27
